                            ...
                            <div class="col-12 tabs_wrapper">
                                ...
                                <div class="row" id="tableBody">
                                    ...
                                    while ($product = mysqli_fetch_assoc($result)) {
                                        ...
                                        $sku = $product['sku'];
                                    ?>
                                        <div class="col-12 col-md-6 col-lg-3 product-add">
...
<script>
    // Use querySelectorAll to select all elements with the class 'searchInput'
    let searchInputs = document.querySelectorAll('.searchInput');

    let allProduct = document.getElementById('all-product');
            // Your input event handler code here
    ...
    for (var i = 0; i < elementsToFilter.length; i++) {
        if (i >= 4) {
            elementsToFilter[i].style.display = 'none'; // Masquer les éléments après le 20ème
        }
    }
    // Iterate over each searchInput element and add an event listener
