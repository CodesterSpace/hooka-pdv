        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <a class="me-3" href="editcategory.php?id=<?php echo $row['category_id']; ?>" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="productdetails">
                                    <ul class="product-bar">
                                        ...
                                        <li>
                                            <h4>Category Code</h4>
                                            <h6><?php echo $row['category_code']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Description</h4>
                                        ...
                                        <li>
                                            <h4>Created At</h4>
                                            <h6><?php echo $row['cat_created_at']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Updated At</h4>
                                            <h6><?php echo $row['cat_updated_at']; ?></h6>
                                        </li>
                                    </ul>
                                </div>
                            </div>
