            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center"><h4>Subcategory List</h4></div>
                            ...
                            <table class="table table-center">
                                <thead class="filmlane-thread">
                                    <tr>
                                        ...
                                        <th class="text-end">
                                            <?php
                                                $sql_count = "SELECT COUNT(*) AS total FROM subcategories";
                                                $result_count = mysqli_query($con, $sql_count) or die(mysqli_error($con));
                                                $row_count = mysqli_fetch_assoc($result_count);
                                                $totalSubcategories = $row_count['total'];
                        ...
                        <div class="table-responsive" size="A4" id="print-area">
                            <table class="table table-center">
                                ...
                                <tbody id="tableBody">
                                    ...
                                    $sql = "SELECT s.*,c.category_id,c.category_name,c.cat_slug
                                    FROM subcategories s
                                    INNER JOIN categories c ON s.category_id = c.category_id 
                                    ORDER BY subcat_created_at DESC LIMIT $per_page OFFSET $offset";
                                    $result = mysqli_query($con, $sql) or die(mysqli_error($con));
                                    $total_pages = ceil($totalSubcategories / $per_page);
                                    $iteration = 0;
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $iteration++;
                                        $date = date("d/m/Y", strtotime($row['subcat_created_at']));
                                    ...
                                    <a href="<?php echo $row['subcat_slug']; ?>" class="product-img">
                                    <img src="assets/img/subcategory/<?php echo $row['subcat_img']; ?>" alt="product">
                                    </a>
                                    <a href="<?php echo $row['subcat_slug']; ?>"><?php echo $row['subcategory_name']; ?></a>
                                    </td>
                                    ...
                                    <td class="no-print">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="btn-group">
                                                <a class="btn btn-inline text-success" href="<?php echo $row['subcat_slug']; ?>">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a class="btn btn-inline text-warning"href="editsubcategory.php?id=<?php echo $row['subcategory_id']; ?>">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a class="btn btn-inline text-danger" href="#" data-bs-toggle="modal" data-bs-target="#delete_subcategory_<?php echo $row['subcategory_id']; ?>">
                                                    <i class="fas fa-trash-alt"></i>
                                                </a>
                                            </div>
                                            <div class="modal custom-modal fade" id="delete_subcategory_<?php echo $row['subcategory_id']; ?>" role="dialog">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content text-center">
                                                        <div class="modal-body">
                                                            <div class="form-header">
                                                                <h3>SUR DE VOULOIR SUPPRIMER ?</h3>
                                                                <small><?php echo $row['subcategory_name']; ?></small>
                                    ...
                                    <div class="col-12">
                                        <div class="">
                                            <?php
                                                ...
                                                $end_entry = min($start_entry + $per_page - 1, $totalSubcategories);
                                            ?>
                                            Affichage de <?php echo $start_entry; ?> à <?php echo $end_entry; ?> sur <?php echo $totalSubcategories; ?> entrées
                                        </div>
                                    </div>
                                        ...
                                        <div class="sama-drop">
                                            <div class="btn-group ml-2">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <button class="dropdown-item per-page" name="per_page" value="<?php echo $totalSubcategories; ?>">All</button>
